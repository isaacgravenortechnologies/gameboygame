 ...
 * gbtdg.js v1.3.2
 * 2014 Chris Antonellis (2022 modified by Isaac Gravenor)
 *
    ...
    getOptionsValues();
		...
		if(o_tile_map === "checked") {
			if(actual_tileData_length < max_map_length) {
				...
				output_buffer += 
					o_var_int + file_name_clean.toUpperCase() + "_TILE_MAP_SIZE " +
					generateHex(actual_mapData_length, o_hex_prefix) + 
					"\r\n" +
					o_var_int + file_name_clean.toUpperCase() + "_TILE_MAP_WIDTH " +
					actual_tile_width + "\r\n" +
					o_var_int + file_name_clean.toUpperCase() + "_TILE_MAP_HEIGHT " +
					actual_tile_height + "\r\n\r\n";
			}
		}
